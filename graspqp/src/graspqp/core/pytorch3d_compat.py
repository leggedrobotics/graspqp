...
def _native_sample_farthest_points(
    points: torch.Tensor, K: int, random_start_point: bool = True
):
    """Greedy furthest-point sampling.
    ...
    if random_start_point:
        sampled_idx[:, 0] = torch.randint(0, N, (B,), device=device)
...
try:
    ...
    def sample_farthest_points(
        ...
        return _p3d_ops.sample_farthest_points(points, K=K, random_start_point=random_start_point)
    ...
    # Meshes and mesh sampling always use the native fallback without pytorch3d.
